...
i = 0
j = 1
# for rate_exc in linspace(0, 30, Npts):
# print(concatenate((linspace(0,3.8,20),linspace(4,30,20))))
# for rate_exc in concatenate((linspace(0,3.8,20),linspace(4,30,20))):
for rate_exc in linspace(0, 80, Npts):
	FRout_inh.append([])
	FRout_exc.append([])
	for rate_inh in linspace(0, 100, Npts):
...
np.save(f'data\\ExpTF_inh_new.npy', FRout_inh)
np.save(f'data\\ExpTF_exc_new.npy', FRout_exc)
plt.figure()
